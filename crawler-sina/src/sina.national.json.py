...
def dowork():
    ...
    while page < 34:
        ...
        url = "http://interface.sina.cn/wap_api/layout_col.d.json?showcid=56262&col=56262&level=1%2C2&show_num=30&page=" + str(page) + "&act=more&jsoncallback=&_=" + timestamp + "&callback=jsonp1"
        work(url)
        page += 1
        #break
